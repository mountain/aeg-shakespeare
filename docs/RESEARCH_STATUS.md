...
| [`boltzmann-bbgky-h-theorem`](../sonnet/boltzmann-bbgky-h-theorem/README.md) | through Phase 1I: exact finite layer adapters, weak/mild collision cells, time-reversal obstruction, hidden Lyapunov cone, and charted target/fibre response ledger | Phase 1J-A order-sensitive collision fixture and Phase 1J-B Deng molecule/cutting response estimate; no hard-sphere H theorem claimed |
