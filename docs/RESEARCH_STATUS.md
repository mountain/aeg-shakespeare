...
| [`brownian-scale-fibre`](../sonnet/brownian-scale-fibre/README.md) | S0/S1 plus compact red team: exact integer-to-cycle deck-fibre pushforward, typed even-cycle period obstruction, exact lazy uniform stationary law, and frozen circle/sphere boundaries | execute the sphere action/stabilizer gate and keep compact time-stationarity separate from line scale-stability before any continuum lowering |
