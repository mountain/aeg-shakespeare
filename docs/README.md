...
45. `API.md` — living semantic public API map: Process → Presentation → Discovery → Analysis.
46. `REFERENCES.md` — shared mathematical bibliography.
47. `RELEASE_CHECKLIST.md` — release gates.
