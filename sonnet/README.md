...
| [`am-power-weight-compiler/`](am-power-weight-compiler/) | T0 contract frozen | native rank-one rational AM power--weight algebra with observer-directed completion and coefficient replay; jets/matrices are only possible observer products | [problem frontier](am-power-weight-compiler/00-problem-frontier.md) and [workstream](../workstreams/am_weight_compiler/); next freeze source, reveal held-out, and compare dependency/support cost with SymPy |
