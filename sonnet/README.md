...
| [`am-conformal-chart-normal-forms/`](am-conformal-chart-normal-forms/) | T0 initialization | auditable contract for fixed-conformal-class chart selection and polynomial-like / matrix-like joint normal forms; no economy theorem yet | [problem frontier](am-conformal-chart-normal-forms/00-problem-frontier.md); next freeze the chart grammar and run the exact Riccati calibration |
