...
| [`finite-le-semantic-evaluator/`](finite-le-semantic-evaluator/) | T0 contract frozen | exact real single-exponential rational-rate semantics; closes only the C2 normal-form/domain/comparison gap exposed by #142 | [problem frontier](finite-le-semantic-evaluator/00-problem-frontier.md) and [frozen workstream](../workstreams/finite_le_semantics/); no general transseries, surreal, or symbolic-height claim |
